...
import (
	...
	"github.com/thehivebot/hive/pkg/commands/hive"
...
func (s *serveCmdOptions) RunE(cmd *cobra.Command, args []string) error {
	...
	dg.UpdateStreamingStatus(0, fmt.Sprintf("version %s BETA", revision), "")

	log.Println("The Hive Bot is now running. Press CTRL-C to exit.")
